...
function Get-TargetResource {
    ...
    $result = @{
        ...
        Enabled      = $config.Octopus.GoogleApps.IsEnabled
        ClientID     = $config.Octopus.GoogleApps.ClientId
        HostedDomain = $config.Octopus.GoogleApps.HostedDomain
    }
